			...
			return `I'm studying at the <a href='https://www.h-ka.de/' class='highlight hka'>Hochschule Karlsruhe</a> and have been active as a working student:
						<ul class='career-list'>
							<li>
								...
								<p class='career-passage'>
									I was the primary engineer of <a href='https://docs.eventsourcingdb.io/reference/eventql/' class='highlight eventql'>EventQL</a>, a self built query language of the <a href='https://eventsourcingdb.io/' class='highlight eventsourcingdb'>EventSourcingDB</a>.
								</p>
							</li>
							<li>
								<span class='career-title'>
